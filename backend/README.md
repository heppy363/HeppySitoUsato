...
* primo contratto `SearchCache` con chiavi deterministiche versionate derivate da query, paginazione, piattaforme, filtri e ordinamento; l'implementazione Redis e il wiring nella ricerca restano separati;
